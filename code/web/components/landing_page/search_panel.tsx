  ...
  return (
    <div className="flex justify-center">
      <div className=" justify-start items-center gap-7 inline-flex">
        <div className="  py-3.5 rounded border border-[#d0d5dd] justify-start items-center flex">
          <div className="text-[#98a2b3] text-sm font-normal font-['Montserrat']">
            Enter a state, locality or area
          </div>
        </div>
        <div className=" pl-4  py-3.5 rounded border border-[#d0d5dd] justify-end items-start  flex">
          <div className="text-[#98a2b3] text-sm font-normal font-['Montserrat']">
            Rent
          </div>
